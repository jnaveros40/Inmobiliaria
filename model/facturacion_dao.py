...
class Facturacion:
    def __init__(self, ID_INQUILINO, NOMBRE_INQUILINO, APELLIDO_INQUILINO, ID_APARTAMENTO, DIRECCION, APARTAMENTO, NOMBRE_PROPIETARIO, APELLIDO_PROPIETARIO, FECHA, FECHA_INICIO, FECHA_FINAL, VALOR):
    ...
    def __str__(self):
        return f'Facturacion[{self.ID_INQUILINO},{self.NOMBRE_INQUILINO},{self.APELLIDO_INQUILINO},{self.ID_APARTAMENTO},{self.DIRECCION},{self.APARTAMENTO},{self.NOMBRE_PROPIETARIO},{self.APELLIDO_PROPIETARIO},{self.FECHA},{self.FECHA_INICIO},{self.FECHA_FINAL},{self.VALOR}]'              

def guardar(facturacion):
    conexion = ConexionDB()

    sql= f"""INSERT INTO FACTURACION (ID_INQUILINO, NOMBRE_INQUILINO, APELLIDO_INQUILINO, ID_APARTAMENTO, DIRECCION, APARTAMENTO, NOMBRE_PROPIETARIO, APELLIDO_PROPIETARIO, FECHA, FECHA_INICIO, FECHA_FINAL, VALOR)
    VALUES( '{facturacion.ID_INQUILINO}',
            '{facturacion.NOMBRE_INQUILINO}',
            '{facturacion.APELLIDO_INQUILINO}',
            '{facturacion.ID_APARTAMENTO}',
...
def editar(facturacion, ID_FACTURACION):
    ...
    SET ID_INQUILINO = '{facturacion.ID_INQUILINO}',
        NOMBRE_INQUILINO = '{facturacion.NOMBRE_INQUILINO}',
        APELLIDO_INQUILINO = '{facturacion.APELLIDO_INQUILINO}',
        ID_APARTAMENTO = '{facturacion.ID_APARTAMENTO}',
